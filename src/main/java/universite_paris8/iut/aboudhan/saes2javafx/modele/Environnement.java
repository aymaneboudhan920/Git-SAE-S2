...
public class Environnement {
    ...
    public boolean updateMicrobes() {
        ...
        for (int i = microbesActifs.size() - 1; i >= 0; i--) {
            ...
            // Calcul des coordonées de la case où se trouve le microbe
            ...
            if (caseI >= 0 && caseI < grille.length && caseJ >= 0 && caseJ < grille[0].length) {
                // On le ralentit si il se trouve sur une case contenant de l'acide ralentissant
            ...
            if (m.getWaypointCible() == null) {
                ...
                microbeSorti = true; // Mettre à true la varibale microbeSorti
            }
        }
        return microbeSorti;
    }
