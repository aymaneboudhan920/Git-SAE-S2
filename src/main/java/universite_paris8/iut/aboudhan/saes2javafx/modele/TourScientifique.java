...
public class TourScientifique extends Tour {
    ...
    public TourScientifique(double x, double y) {
        super(x, y, 170, 10, 1.0, prixAchat, "/universite_paris8/iut/aboudhan/saes2javafx/vue/tour_scientifique.png", "/universite_paris8/iut/aboudhan/saes2javafx/vue/seringue.png");
    }
