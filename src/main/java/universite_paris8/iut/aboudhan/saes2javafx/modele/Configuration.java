...
public class Configuration {
    ...
    private final String[] pagesTutoriel;
    private int pageTutorielCourante;
    ...
    public Configuration() {
        ...
        this.pagesTutoriel = new String[]{
                ...
                "Les Potions :\n\nVous disposez aussi de 3 types de potions (Soin, Rage, Gel). Utilisez-les au bon moment pour inverser le cours de la partie !",
                "Le Shop :\n\nBien évidemment, il va de soi qu'il faut un shop pour pouvoir équiper son arsenal de la meilleure façon possible !"
        };
        this.pageTutorielCourante = 0;
    ...
    private void initialiserEtJouerMusique() {
        chargerEtJouerClip("/universite_paris8/iut/aboudhan/saes2javafx/musique3.wav");
    }
    ...
    public String getTexteTutorielCourant() { return pagesTutoriel[pageTutorielCourante]; }
    public void pageSuivante() { if (pageTutorielCourante < pagesTutoriel.length - 1) pageTutorielCourante++; }
    public void pagePrecedente() { if (pageTutorielCourante > 0) pageTutorielCourante--; }
    public boolean estPremierePage() { return pageTutorielCourante == 0; }
    public boolean estDernierePage() { return pageTutorielCourante == pagesTutoriel.length - 1; }
    public void reinitialiserTutoriel() { this.pageTutorielCourante = 0; }
}